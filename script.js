document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('blur', function (e) {
    ...
    const existingError = document.getElementById((field.id || field.name || 'field') + '-error');
    if (existingError) {
    ...
    if (field.hasAttribute('required') && value === '') {
      ...
      errorMessage = getErrorMessage(field, 'email');
    } else if (value !== '' && type === 'tel' && !isValidPhone(value)) {
      errorMessage = getErrorMessage(field, 'tel');
    }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "OpsPanel משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '63faff59-6b24-4eef-8d86-ca19f00a5ac7',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '63faff59-6b24-4eef-8d86-ca19f00a5ac7';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '63faff59-6b24-4eef-8d86-ca19f00a5ac7';
